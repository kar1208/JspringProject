...
<div class="container">
  ...
  <form name="myform" method="post">
    ...
    <table class="table table-bordered">
      ...
      <tr>
	      <th>구매 물품명</th>
	      <td><input type="text" name="name" value="컴퓨터" class="form-control"/></td>
      </tr>
      <tr>
	      <th>이메일</th>
	      <td><input type="text" name="buyer_email" value="beorc8686@naver.com" class="form-control"/></td>
      </tr>
      <tr>
	      <th>주문자</th>
	      <td><input type="text" name="buyer_name" value="중원" class="form-control"/></td>
      </tr>
      <tr>
	      <th>연락처</th>
	      <td><input type="text" name="buyer_tel" value="010-9366-7008" class="form-control"/></td>
      </tr>
      <tr>
	      <th>주소</th>
