...
<head>
  ...
  <script>
    ...
    function modalCheck4(mid, name, nickName, birthday, job) {
    	var memberList = ${memberList};
    	
    	$("#myModal9 .modal-body .mid").html(mid);
    	$("#myModal8 .modal-body .name").html(name);
    	$("#myModal8 .modal-body .nickName").html(nickName);
    	$("#myModal8 .modal-body .birthday").html(birthday);
    	$("#myModal8 .modal-body .job").html(job);
...
<div class="container">
  ...
  <div>
    ...
    <button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#myModal9">Open modal 9</button>
  </div>
</div>
...
<div class="modal fade" id="myModal9">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
				<table class="table table-hover text-senter">
