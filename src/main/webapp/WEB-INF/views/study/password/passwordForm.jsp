  ...
  <script>
  	...
  	function bCryptPasswordCheck() {
  		...
  		$.ajax ({
  			...
  			success:function(res) {
  				cnt++;
  				str += cnt + "(bCryptPasswordCheck) : " + res + "<br/>";
  				$("#demo").html(str);
  			},
  			error:function() { alert("전송오류"); }
  		});
...
<div class="container" >
	...
	<div class="input-group">
		<input type="text" name="pwd" id="pwd" value="1234" autofocus class="form-control" />
	...
	<hr class="border-secondary"/>
		<div>
			...
			<input type="button" value="BCryptPasswordCheck" onclick="bCryptPasswordCheck()" class="btn btn-success">
			<input type="button" value="ariaCHeck" onclick="ariaCheck()" class="btn btn-success">
		</div>
	<hr class="border-secondary"/>
	<div>
		출력결과 : <br/>
