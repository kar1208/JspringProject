  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="${ctp}/user/userMain" class="w3-bar-item w3-button">SessionTemplate</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="${ctp}/guest/boardList" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">Board</a>
  <a href="${ctp}/guest/pdsList" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">PDS</a>
  <a href="${ctp}/guest/loginList" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">Login</a>
  <a href="${ctp}/guest/logoutList" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">Logout</a>
  <a href="${ctp}/guest/joinList" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">Join</a>
</div>