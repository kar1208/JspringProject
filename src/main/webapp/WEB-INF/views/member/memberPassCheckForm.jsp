...
<div class="container">
  ...
  <form name="myform" method="post" action="${ctp}/member/pwdChange">
	      ...
	      <tr>
	        <th>새로운 비밀번호</th>
	        <td><input type="password" name="pwd" id="pwd" value="1234" placeholder="새로운 비밀번호를 입력하세요." required class="form-control" /></td>
	      </tr>
	      <tr>
	        <th>비밀번호 확인</th>
	        <td><input type="password" name="rePwd" id="rePwd" value="1234" placeholder="비밀번호를 한번더 입력하세요." required class="form-control" /></td>
	      </tr>
	      <tr>
	        <td colspan="2">
