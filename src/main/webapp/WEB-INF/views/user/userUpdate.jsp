...
<div class="container">
  <form method = "post">
  	 <table class="table table-bordered text-center">
  		...
  		<tr>
  			<th>아이디</th>
  			<td><input type="text" name="mid" id="mid" value="${vo.idx}" autofocus required class="form-control"></td>
  		</tr>
  		<tr>
  			<th>비밀번호</th>
  		...
  		<tr>
  			<th>성명</th>
  			<td><input type="text" name="name" id="name" value="${vo.mid}" required class="form-control"></td>
  		</tr>
  		<tr>
  			<th>나이</th>
  		...
  		<tr>
  			<th>성별</th>
  			<td><input type="radio" name="gender" id="gender1" value="남자" ${vo.gender=='남자' ? 'checked' : '' }/>남자 &nbsp;
  		...
  		<tr>
  			<td colspan="2">
  				...
  				<input type="reset" value="다시입력" class="btn btn-primary me-2" />
  				<input type="button" value="돌아가기" onclick="location.href='userMain';" class="btn btn-warning" />
  			</td>
  		</tr>
  	</table>
