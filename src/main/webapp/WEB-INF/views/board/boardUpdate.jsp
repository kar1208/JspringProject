...
<div class="container">
  ...
  <form name="myform" method="post">
  	<table class="table table-bordered">
  		...
  		<tr>
  			<th>글내용</th>
  			<td><textarea rows="10" name="content" in="CKEDITOR" placeholder="글내용을 입력하세요." class="form-control" required>${vo.content}</textarea><a>
					<script>
  		...
  		<tr>
  			<th>공개여부</th>
  			<td>
  				<input type="radio" name="openSw" id="openSw" value="OK" ${vo.openSw == 'OK' ? 'checked' : ''} /> 공개 &nbsp; 
  				<input type="radio" name="openSw" id="openSw" value="NO" ${vo.openSw == 'NO' ? 'checked' : ''} /> 비공개 
  			</td>
  		</tr>
  		<tr>
