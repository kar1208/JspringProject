...
<div class="container">
  ...
  <table class="table table-borderless m-0 p-0">
    <tr>
      ...
      <c:if test="${!empty pageVo.searchStr}">
      	<td class="text-end">
      		<font color='blue'>${pageVo.searchStr}</font>으로 <font color="orange">${pageVo.searchString}</font>를(을) 검색한 결과 <font color="red">${fn:length(vos)}</font>건이 출력되었습니다.
      	</td>
      </c:if>
    </tr>
  </table>
...
<!-- 블록페이지 시작 -->
  ...
  <!-- 검색기 시작 -->
  <div class="text-center">
		<!-- <form action="searchForm" method="post" action="boardSearchList"> -->
